 ...
 * generated in the org.ban.services.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreditCheck_QNAME = new QName("http://www.localhost:8080.com/ejb/credit", "CreditCheck");
    private final static QName _CreditCheckResponse_QNAME = new QName("http://www.localhost:8080.com/ejb/credit", "CreditCheckResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ban.services.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.localhost:8080.com/ejb/credit", name = "CreditCheck")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.localhost:8080.com/ejb/credit", name = "CreditCheckResponse")
